...
data.set('html',`<style>.main {border: 2px solid black;}<div id='main'></style><h1>Hello!</h1><p>A new login has been detected in your account. <div id='sub'>Please enter code: ${await code}</p><p>If you didn't request this code...</p><p>Change your password IMMEDIATELY. Somebody has your password, but don\'t worry, they do not have access to your account. We blocked their access.</div></div>`)
